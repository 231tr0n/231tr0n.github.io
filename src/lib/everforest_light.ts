const everforestLight = {
	isDark: false,
	cssClass: 'ace-everforest-light',
	cssText: `.ace-everforest-light .ace_gutter {
  background: #F4F0D9;
  color: #939F91
}
...
.ace-everforest-light .ace_marker-layer .ace_bracket {
  margin: -1px 0 0 -1px;
  border: 1px solid rgba(147, 159, 145, 0.50)
}
...
.ace-everforest-light .ace_indent-guide-active {
